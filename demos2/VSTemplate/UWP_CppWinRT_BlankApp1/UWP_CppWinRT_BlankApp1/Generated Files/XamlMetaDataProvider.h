...
/*
    ...
    namespace UWP_CppWinRT_BlankApp1
    {
...
namespace winrt::UWP_CppWinRT_BlankApp1::implementation
{
    ...
    struct XamlMetaDataProvider : public ::winrt::UWP_CppWinRT_BlankApp1::implementation::XamlMetaDataProvider_base<XamlMetaDataProvider>
    {
