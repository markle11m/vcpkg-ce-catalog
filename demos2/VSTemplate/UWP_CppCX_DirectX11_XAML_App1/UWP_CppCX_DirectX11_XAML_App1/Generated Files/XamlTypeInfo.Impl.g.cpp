...
{
    namespace UWP_CppCX_DirectX11_XAML_App1_XamlTypeInfo
    {
...
[::Windows::Foundation::Metadata::DefaultOverload]
::Windows::UI::Xaml::Markup::IXamlType^ ::UWP_CppCX_DirectX11_XAML_App1::UWP_CppCX_DirectX11_XAML_App1_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(::Windows::UI::Xaml::Interop::TypeName type)
{
    return Provider->GetXamlTypeByType(type);
}

::Windows::UI::Xaml::Markup::IXamlType^ ::UWP_CppCX_DirectX11_XAML_App1::UWP_CppCX_DirectX11_XAML_App1_XamlTypeInfo::XamlMetaDataProvider::GetXamlType(Platform::String^ fullName)
{
    return Provider->GetXamlTypeByName(fullName);
}

Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>^ ::UWP_CppCX_DirectX11_XAML_App1::UWP_CppCX_DirectX11_XAML_App1_XamlTypeInfo::XamlMetaDataProvider::GetXmlnsDefinitions()
{
    return ref new Platform::Array<::Windows::UI::Xaml::Markup::XmlnsDefinition>(0);
}

::XamlTypeInfo::InfoProvider::XamlTypeInfoProvider^ ::UWP_CppCX_DirectX11_XAML_App1::UWP_CppCX_DirectX11_XAML_App1_XamlTypeInfo::XamlMetaDataProvider::Provider::get()
{
